...
namespace KirboMod.UI
{
	internal class FighterComboMeter : UIState
	{
        ...
        public override void OnInitialize() 
		{
			...
			area = new UIElement();
			area.Left.Set(-area.Width.Pixels - 896, 1f); // Place the meter somewhere in the middle
			area.Top.Set(490, 0f); // Placing it around the middle of the screen
			area.Width.Set(50, 0f); // We will be placing the following UIElement within this 50x18 area.
		...
		public override void Draw(SpriteBatch spriteBatch) {
			...
			if (!(Main.LocalPlayer.HeldItem.ModItem is FighterGlove) && !(Main.LocalPlayer.HeldItem.ModItem is MetalFighter))
				return;
		...
		protected override void DrawSelf(SpriteBatch spriteBatch) {
			...
			var modPlayer = Main.LocalPlayer.GetModPlayer<KirbPlayer>();
            // Calculate quotient
