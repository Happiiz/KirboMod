                ...
                else if (attack >= 300) //START FROM HERE
                {
                    ...
                    if (attacktype == DededeAttackType.DarkShot) //eye
                    {
                        ...
                        if (attack == 580 || (attack == 640 && Main.expertMode))
                        {
                            ...
                            {
                                Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center.X + NPC.direction * 150, NPC.Center.Y - 30, NPC.velocity.X * 0, NPC.velocity.Y * 0, ModContent.ProjectileType<Projectiles.DarkOrb>(), 50 / 2, 10f, Main.myPlayer, 0, NPC.target, Main.expertMode ? 1 : 0);
                            }
