...
namespace KirboMod.Tiles.Relics
{
	...
	/*public class ZeroRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "KirboMod/Tiles/Relics/ZeroRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			...
			switch (placeStyle) {
				case 0:
					itemType = ModContent.ItemType<Items.Placeables.BossRelics.ZeroRelic>();
					break;
	...
	public class ZeroRelic : WhispyWoodsRelic
	{
		public override string RelicTextureName => "KirboMod/Tiles/Relics/ZeroRelic";
	}
