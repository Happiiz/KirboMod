...
namespace KirboMod.Tiles.Relics
{
	...
	/*public class KingDededeRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "KirboMod/Tiles/Relics/KingDededeRelic";
	...
	public class KingDededeRelic : WhispyWoodsRelic
	{
		public override string RelicTextureName => "KirboMod/Tiles/Relics/KingDededeRelic";
