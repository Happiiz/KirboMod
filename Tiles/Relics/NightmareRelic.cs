...
namespace KirboMod.Tiles.Relics
{
	...
	/*public class NightmareRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "KirboMod/Tiles/Relics/NightmareRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			...
			switch (placeStyle) {
				case 0:
					itemType = ModContent.ItemType<Items.Placeables.BossRelics.NightmareRelic>();
					break;
	...
	public class NightmareRelic : WhispyWoodsRelic
	{
		public override string RelicTextureName => "KirboMod/Tiles/Relics/NightmareRelic";
	}
