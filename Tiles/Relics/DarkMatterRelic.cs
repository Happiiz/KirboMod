...
namespace KirboMod.Tiles.Relics
{
	...
	/*public class DarkMatterRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "KirboMod/Tiles/Relics/DarkMatterRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "KirboMod/Tiles/RelicPedestal";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			...
			switch (placeStyle) {
				case 0:
					itemType = ModContent.ItemType<Items.Placeables.BossRelics.DarkMatterRelic>();
					break;
	...
	public class DarkMatterRelic : WhispyWoodsRelic
	{
		public override string RelicTextureName => "KirboMod/Tiles/Relics/DarkMatterRelic";
	}
