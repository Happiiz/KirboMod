...
namespace KirboMod.Tiles.Relics
{
	...
	/*public class KrackoRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "KirboMod/Tiles/Relics/KrackoRelic";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			...
			switch (placeStyle) {
				case 0:
					itemType = ModContent.ItemType<Items.Placeables.BossRelics.KrackoRelic>();
					break;
	...
	public class KrackoRelic : WhispyWoodsRelic
	{
		public override string RelicTextureName => "KirboMod/Tiles/Relics/KrackoRelic";
	}
