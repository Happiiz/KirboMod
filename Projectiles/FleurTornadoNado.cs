...
{
	public class FleurTornadoNado : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Vector2 speed = Main.rand.NextVector2Circular(25f, 25f); //circle
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, speed, ModContent.ProjectileType<Projectiles.FleurTornadoFeather>(), Projectile.damage, 5f, Projectile.owner);
			}
		}
        ...
        public override void Kill(int timeLeft)
        {
			...
			for (int i = 0; i < 10; i++) //first semicolon makes inital statement once //second declares the conditional they must follow // third declares the loop
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, speed * 25, ModContent.ProjectileType<Projectiles.FleurTornadoFeather>(), Projectile.damage, 5f, Projectile.owner);
			}
		}
