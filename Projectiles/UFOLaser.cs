...
namespace KirboMod.Projectiles
{
    public class UFOLaser : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            CheckCreateDropStarsInTransformationMod();
        ...
        private void CheckCreateDropStarsInTransformationMod()
        {
            if (Projectile.timeLeft % Projectile.MaxUpdates != 0)
            {
                return;
            }
            //shoots very sparsely, so this much damage is fine
            int droppedStarDamage = 1000;
            KirbyTransformationModCompatibilityHelper.SpawnDroppedStarWhenProjectilesGoesPastPlayer(droppedStarDamage, Projectile, ref playersCreatedDropStarsForInTransformationMod);
        }
