...
namespace KirboMod.Projectiles
{
    public class SpaceRangerOrb : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 0, ModContent.ProjectileType<Projectiles.SpaceRangerOrbField>(), Projectile.damage, 0, Projectile.owner, 0, 0);
            }
        }
    }
}