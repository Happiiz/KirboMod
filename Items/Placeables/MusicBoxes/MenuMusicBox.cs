...
namespace KirboMod.Items.Placeables.MusicBoxes
{
	public class MenuMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/Photonic0_MilkywayWishes_WithLoopMetadata"), ModContent.ItemType<MenuMusicBox>(), ModContent.TileType<MenuMusicBoxTile>());
		}
