...
namespace KirboMod.Items.Placeables.MusicBoxes
{
	public class DreamLandBossMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/Evobyte_KdlBoss"), ModContent.ItemType<DreamLandBossMusicBox>(), ModContent.TileType<DreamLandBossMusicBoxTile>());
		}
