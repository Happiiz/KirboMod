...
namespace KirboMod.Items.Placeables.MusicBoxes
{
	public class MrFrostyMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Music/Photonic0_FrostyBattle"), ModContent.ItemType<MrFrostyMusicBox>(), ModContent.TileType<MrFrostyMusicBoxTile>());
		}
