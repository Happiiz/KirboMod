...
{
	public class WhispyBag : ModItem
	{
        ...
        {
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<WhispyMask>(), 7));
            itemLoot.Add(ItemDropRule.Common(ItemID.Wood, 1, 20, 20)); //hell yeah

            itemLoot.Add(new OneFromRulesRule(1, ItemDropRule.Common(ModContent.ItemType<Items.Weapons.SwishyTree>(), 1)
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<WhispyBush>()));

            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<NPCs.Whispy>())); // drop money
        }
