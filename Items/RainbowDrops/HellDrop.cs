...
{
	public class HellDrop : ModItem
	{
		public override void SetStaticDefaults() 
		{
			// DisplayName.SetDefault("Orange Drop");
			ItemID.Sets.SortingPriorityMaterials[Item.type] = 1014;
            ...
            // Tooltip.SetDefault("The rainbow drop of the burning hellscape");
