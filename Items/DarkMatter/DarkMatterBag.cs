...
{
	public class DarkMatterBag : ModItem
	{
        ...
        {
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<DarkMatterMask>(), 7));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<DarkMaterial>(), 1, 30, 30));
