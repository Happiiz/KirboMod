...
{
	public class CrownOfFire : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Crown Of Fire");
			// Tooltip.SetDefault("Summons a burning leo to fight for you");
		...
		public override void SetDefaults()
		{
			...
			Item.height = 33; //for world hitbox
			Item.useTime = 36;
			...
			Item.buffType = ModContent.BuffType<Buffs.MinionBuffs.BurningLeoBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ModContent.ProjectileType<Projectiles.BurningLeoMinion>();
		}
