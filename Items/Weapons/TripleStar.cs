...
namespace KirboMod.Items.Weapons
{
    public class TripleStar : ModItem
    {
        ...
        public override void RightClick(Player player)
        {
            ...
            {
                Main.NewText("You must not have this weapon selected to reset the star projectile identities!", Color.Red);
                return;
            }
            if (Main.netMode == NetmodeID.MultiplayerClient)
            {
                NetMethods.SendBugfixResetTripleStarStarIdentities(player);
            }
            ...
            Main.NewText("indices reset!", Color.Magenta);
            if (Main.netMode == NetmodeID.MultiplayerClient)
            {
                Main.NewText("Ask everyone else if they received a message about it!", Color.Magenta);
            }
