...
{
	public class CrownOfIce : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Crown Of Ice");
			// Tooltip.SetDefault("Summons a chilly to fight for you");
        ...
        public override void SetDefaults()
		{
			...
			Item.knockBack = 1;
			Item.mana = 8;
			Item.width = 15; //for world hitbox
			Item.height = 16; //for world hitbox
			Item.useTime = 36;
			...
			Item.buffType = ModContent.BuffType<Buffs.MinionBuffs.ChillyBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ModContent.ProjectileType<Projectiles.ChillyMinion>();
		}
