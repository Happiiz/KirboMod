...
namespace KirboMod.Items.Weapons
{
	public class CrystalNeedle : ModItem
	{
		...
		public override void AddRecipes()
		{
			...
			recipe1.AddIngredient(ModContent.ItemType<ClutterNeedle>(), 100); //Clutter Needle
			recipe1.AddIngredient(ItemID.CrystalShard, 5); //5 crystals
			recipe1.AddIngredient(ItemID.BeetleHusk); //1 Beetle Husk
			recipe1.AddIngredient(ModContent.ItemType<Starbit>(), 15); //15 starbits
			recipe1.AddIngredient(ModContent.ItemType<TreasureStone>(), 1); //1 rare stone
            recipe1.AddIngredient(ModContent.ItemType<SoulMatter>(), 1); //soul matter
